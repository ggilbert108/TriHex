...
(function BigInteger$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:false, Public:true }, ".ctor", 
      JSIL.MethodSignature.Action($asm05.TypeRef("System.Decimal"))
    )
      .Attribute($asm0B.TypeRef("__DynamicallyInvokableAttribute"));
    ...
    $.ExternalMethod({Static:false, Public:false}, "AssertValid", 
      ...
      .Attribute($asm05.TypeRef("System.Diagnostics.ConditionalAttribute"), function () { return ["DEBUG"]; });
    ...
    $.ExternalMethod({Static:true , Public:true }, "op_Explicit", 
      new JSIL.MethodSignature($.Type, [$asm05.TypeRef("System.Decimal")])
    )
      .Attribute($asm0B.TypeRef("__DynamicallyInvokableAttribute"));
    ...
    $.ExternalMethod({Static:true , Public:true }, "op_Explicit", 
      new JSIL.MethodSignature($asm05.TypeRef("System.Decimal"), [$.Type])
    )
      .Attribute($asm0B.TypeRef("__DynamicallyInvokableAttribute"));
    ...
    $.ExternalMethod({Static:true , Public:true }, "Parse", 
      new JSIL.MethodSignature($.Type, [$.String, $asm05.TypeRef("System.Globalization.NumberStyles")])
    )
      .Attribute($asm0B.TypeRef("__DynamicallyInvokableAttribute"));

    $.ExternalMethod({Static:true , Public:true }, "Parse", 
      new JSIL.MethodSignature($.Type, [$.String, $asm05.TypeRef("System.IFormatProvider")])
    )
      .Attribute($asm0B.TypeRef("__DynamicallyInvokableAttribute"));

    $.ExternalMethod({Static:true , Public:true }, "Parse", 
      new JSIL.MethodSignature($.Type, [
          $.String, $asm05.TypeRef("System.Globalization.NumberStyles"), 
          $asm05.TypeRef("System.IFormatProvider")
        ])
    )
      .Attribute($asm0B.TypeRef("__DynamicallyInvokableAttribute"));
    ...
    $.ExternalMethod({Static:false, Public:true }, "ToString", 
      new JSIL.MethodSignature($.String, [$asm05.TypeRef("System.IFormatProvider")])
    )
      .Attribute($asm0B.TypeRef("__DynamicallyInvokableAttribute"));
    ...
    $.ExternalMethod({Static:false, Public:true , Virtual:true }, "ToString", 
      new JSIL.MethodSignature($.String, [$.String, $asm05.TypeRef("System.IFormatProvider")])
    )
      .Attribute($asm0B.TypeRef("__DynamicallyInvokableAttribute"));
    ...
    $.ExternalMethod({Static:true , Public:true }, "TryParse", 
      new JSIL.MethodSignature($.Boolean, [
          $.String, $asm05.TypeRef("System.Globalization.NumberStyles"), 
          $asm05.TypeRef("System.IFormatProvider"), $jsilcore.TypeRef("JSIL.Reference", [$.Type])
        ])
    )
      .Attribute($asm0B.TypeRef("__DynamicallyInvokableAttribute"));
    ...
    $.ImplementInterfaces(
      /* 0 */ $asm05.TypeRef("System.IFormattable"), 
      /* 1 */ $asm05.TypeRef("System.IComparable"), 
      /* 2 */ $asm05.TypeRef("System.IComparable`1", [$.Type]), 
      /* 3 */ $asm05.TypeRef("System.IEquatable`1", [$.Type])
    );
...
(function Complex$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ImplementInterfaces(
      ...
      /* 1 */ $asm05.TypeRef("System.IFormattable")
    );
...
(function BigIntegerBuilder$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:false, Public:true }, ".ctor", 
      JSIL.MethodSignature.Action($asm0B.TypeRef("System.Numerics.BigInteger"))
    );
  ...
  JSIL.MakeStaticClass("System.Numerics.BigNumber", false, [], function ($interfaceBuilder) {
    ...
    $.ExternalMethod({Static:true , Public:false}, "FormatBigInteger", 
      new JSIL.MethodSignature($.String, [
          ...
          $asm05.TypeRef("System.Globalization.NumberFormatInfo")
        ])
    )
    ...
    $.ExternalMethod({Static:true , Public:false}, "FormatBigIntegerToHexString", 
      new JSIL.MethodSignature($.String, [
          ...
          $.Int32, $asm05.TypeRef("System.Globalization.NumberFormatInfo")
        ])
    );
    ...
    $.ExternalMethod({Static:true , Public:false}, "TryParseBigInteger", 
      new JSIL.MethodSignature($.Boolean, [
          $.String, $asm05.TypeRef("System.Globalization.NumberStyles"), 
          $asm05.TypeRef("System.Globalization.NumberFormatInfo"), $jsilcore.TypeRef("JSIL.Reference", [$asm0B.TypeRef("System.Numerics.BigInteger")])
        ])
    )
      .Attribute($asm05.TypeRef("System.Security.SecuritySafeCriticalAttribute"));

    $.ExternalMethod({Static:true , Public:false}, "TryValidateParseStyleInteger", 
      new JSIL.MethodSignature($.Boolean, [$asm05.TypeRef("System.Globalization.NumberStyles"), $jsilcore.TypeRef("JSIL.Reference", [$asm05.TypeRef("System.ArgumentException")])])
    );
...
(function BigNumberBuffer$Members () {
  ...
  JSIL.MakeType({
    ...
    $.Field({Static:false, Public:true }, "digits", $asm05.TypeRef("System.Text.StringBuilder")); 
